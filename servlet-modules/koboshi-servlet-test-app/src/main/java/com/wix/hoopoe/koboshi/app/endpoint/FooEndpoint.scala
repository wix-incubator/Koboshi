...
class FooEndpoint extends HttpServlet {
  ...
  override def init(): Unit = {
    ...
    val (caches, registry) = ResilientCaches.resilientCachesAndRegistry(persistentCopyFile)
    ...
    getServletContext.setAttribute(ResilientCacheRegistryEndpoint.RegistryKey, registry)
  }
